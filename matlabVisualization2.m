...
for i = 3:5
    ...
    subplot(1, 3, i - 2);
    hold on;
    plot(dataNO(:, 9), dataNO(:, 8), '-*', 'DisplayName', 'Non Offloading', 'Color', 'green', 'LineWidth', 1.3, 'MarkerIndices', markerIndices, 'MarkerSize', 4);
    plot(dataODO(:, 9), dataODO(:, 8), '-o', 'DisplayName', 'ODO', 'Color', '#f5b642', 'LineWidth', 1.3, 'MarkerIndices', markerIndices, 'MarkerSize', 4);
    plot(dataGBO(:, 9), dataGBO(:, 8), '-d', 'DisplayName', 'GBO', 'Color', 'red', 'LineWidth', 1.3, 'MarkerIndices', markerIndices, 'MarkerSize', 6);
